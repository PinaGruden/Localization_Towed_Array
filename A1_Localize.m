...
plot_AS(AStotal_S,NewGrid{1},hyph_pos,boat_pos,Loc_table.Loc_m,est_loc_bounds);
...
plot_AS(ASdilatetotal_S,NewGrid{1},hyph_pos,boat_pos,Loc_table.Loc_m_dilated,est_loc_bounds);
